...
import { deliverPackagesController } from '../../controllers/packages/deliverPackagesController.js';
 ...
 * /packages/{id}/deliver:
 *   post:
 *     summary: Sätt paket till DELIVERED
 *     description: Växlar status från IN_TRANSIT till DELIVERED för ett specifikt paket.
 *     tags:
 *       - Packages
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Paket satt till DELIVERED
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *       409:
 *         description: Ogiltig statusövergång (kräver att nuvarande status är IN_TRANSIT)
 *       500:
 *         description: Internt serverfel
 */
router.post('/packages/:id/deliver', deliverPackagesController);
